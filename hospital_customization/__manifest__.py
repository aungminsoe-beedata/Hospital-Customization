...
Long description of module's purpose
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'hospital_customization/static/src/xml/Hospital_Dashboard_View.xml',
            'hospital_customization/static/src/js/Hospital_Dashboard.js',
        ...
        #    'hospital_customization/static/src/xml/js_test.xml',
           ...
           # Web Cam Access
            ...
            'hospital_customization/static/src/js/webcam.scss',
            
            'hospital_customization/static/src/xml/image_upload_templates.xml',
            'hospital_customization/static/src/js/ImageField.js',
            'hospital_customization/static/src/xml/camera_dialog_templates.xml',
            'hospital_customization/static/src/js/CameraDialog.js'
        ],
    },
